...
create directories (folders) for **scripts**, **data**, and **documents**.
 ...
 - **`data/`** Use this folder to store your raw data and intermediate
   ...
   `data/raw/tree_survey.plot1.txt` and `data/raw/tree_survey.plot2.txt` kept separate from
...
```{r kitten-fig, results='markup', echo=FALSE, purl=FALSE, out.width='400px', fig.align='center'}
